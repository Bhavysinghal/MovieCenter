        ...
        <div className={`footer-links ${isMenuOpen ? "mobile-open" : ""}`}>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-list">
              <li>
                <a href="/about">About SCSDB</a>
              </li>
              <li>
                <a href="/contactus">Contact Us</a>
              </li>
              <li>
                <a href="/support">Support Forums</a>
              </li>
              <li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-list">
              <li>
                <a href="/contribute">Contribution Bible</a>
              </li>
              <li>
                <a href="/add-movie">Add New Movie</a>
              </li>
              <li>
                <a href="/add-show">Add New TV Show</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-list">
              ...
              <li>
                <a href="/api-terms">API Terms of Use</a>
              </li>
              <li>
