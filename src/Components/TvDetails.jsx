...
const TvDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="relative w-full min-h-screen px-3 sm:px-6 lg:px-[10%] overflow-x-hidden"
    >
      {/* Part 1 - Navigation */}
      <nav className="w-full h-auto flex flex-wrap justify-center sm:justify-start items-center text-zinc-100 gap-4 sm:gap-6 lg:gap-10 text-base sm:text-lg py-4">
        <Link
          onClick={() => navigate(-1)}
      ...
      <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-10 mb-8 items-center lg:items-start">
        {/* Poster */}
        ...
        {/* Details */}
        <div className="content lg:ml-[5%] text-white text-center lg:text-left animate-fadeIn">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl text-white font-black leading-tight break-words">
            {info.detail.name ||
              info.detail.title ||
          ...
          {/* Ratings */}
          <div className="mt-4 mb-6 flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-x-6 text-center sm:text-left">
            <div className="flex items-center gap-4">
              ...
              <h1 className="font-semibold text-xl sm:text-2xl leading-6">
                User Score
              </h1>
            </div>
      ...
      <div className="w-full flex flex-col gap-y-5 mt-8 lg:mt-10">
        {info.watchproviders && info.watchproviders.buy && (
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-x-10 items-center sm:items-start text-white text-center sm:text-left px-2">
      ...
      <h1 className="text-2xl sm:text-3xl mt-6 lg:mt-8 font-bold text-white text-center lg:text-left px-3 sm:px-6 lg:px-0">
        Seasons
      </h1>
      <div className="w-full overflow-x-auto mb-5 p-3 sm:p-5">
        <div className="flex gap-4 sm:gap-5 min-w-max">
          {info.detail.seasons.length > 0 ? (
            info.detail.seasons.map((s, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-[200px] sm:w-[220px] lg:w-[14vw]"
              >
                <img
      ...
      <div className="mt-4 mb-12 px-2 sm:px-4">
        <HorizontalCards
          data={
